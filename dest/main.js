...
var Promise, URLs, addCallback, getJSONP, getJSONPAll, jsonp;

Promise = require('bluebird');

jsonp = require('jsonp-client');

URLs = ['http://marks-contents.s3.amazonaws.com/universal/jsonp/new_release.jsonp?callback=new_release', 'http://marks-contents.s3.amazonaws.com/universal/jsonp/2000drama_youth.jsonp?callback=drama_youth2000', 'http://marks-contents.s3.amazonaws.com/universal/jsonp/1990drama_youth.jsonp?callback=drama_youth1990', 'http://marks-contents.s3.amazonaws.com/universal/jsonp/1980drama_youth.jsonp?callback=drama_youth1980', 'http://marks-contents.s3.amazonaws.com/universal/jsonp/1970drama_youth.jsonp?callback=drama_youth1970', 'http://marks-contents.s3.amazonaws.com/universal/jsonp/1960drama_youth.jsonp?callback=drama_youth1960', 'http://marks-contents.s3.amazonaws.com/universal/jsonp/1950drama_youth.jsonp?callback=drama_youth1950'];
...
getJSONP = function(url) {
  return new Promise(function(resolve, reject) {
    return jsonp(addCallback(url), function(err, date) {
      if (err != null) {
        return reject(err);
      } else {
        return resolve(date);
...
getJSONPAll = function(urlList) {
  var i, promises, url;
  promises = (function() {
    var _i, _len, _results;
    _results = [];
    for (i = _i = 0, _len = urlList.length; _i < _len; i = ++_i) {
      url = urlList[i];
      _results.push(getJSONP(url));
    }
    return _results;
  })();
...
getJSONPAll(URLs).then(function(data) {
...
},{"bluebird":4,"jsonp-client":39}],2:[function(require,module,exports){
"use strict";
...
},{"./queue.js":26,"./schedule.js":29,"_process":38}],4:[function(require,module,exports){
"use strict";
var old;
